...
export const flowCards: Array<{
...
}> = [
  {
    ...
    description: 'Collect approved checklist or form data needed to start an insurance workflow.',
  ...
  },
  {
    ...
    description: 'Ask focused follow-up questions when figures, dates, documents, or sources are missing.',
  ...
  },
  {
    ...
    description: 'Confirm what changed since last year before a renewal is processed.',
